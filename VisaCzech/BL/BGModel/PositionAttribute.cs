...
namespace VisaCzech.BL.BGModel
{
    ...
    public sealed class PositionAttribute : Attribute
    {
        ...
        private void CreateConverter()
        {
            switch (_convType)
            {
                case ConverterType.Long: _converter = new LongDateTimeConverter(); break;
                case ConverterType.ShortDsMsY: _converter = new DateDsMsYConverter(); break;
                case ConverterType.ShortYmMmD: _converter = new DateYmMmDConverter(); break;
                case ConverterType.ShortYsMsD: _converter = new DateYsMsDConverter(); break;
                case ConverterType.Bool: _converter = new BoolConverter(_checkBoxValues); break;
        ...
        public PositionAttribute()
        {
            ...
            ColSpan = 1;
            _convType = ConverterType.String;
            _checkBoxValues = "Y|N";
            CreateConverter();
